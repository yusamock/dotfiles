...
hi Comment            guibg=NONE         guifg=#7D8284
...
hi LineNr             guibg=NONE         guifg=#7D8284
...
hi Search             guibg=#A29D9F      guifg=#ffffff
...
hi SpellBad           guibg=#C7C1BE      guifg=#0B0D0F
hi SpellCap           guibg=NONE         guifg=#C7C1BE
hi SpellLocal         guibg=NONE         guifg=#C7C1BE
hi SpellRare          guibg=NONE         guifg=#C7C1BE
hi Statement          guibg=NONE         guifg=#ffffff
hi StatusLine         guibg=#9a9997      guifg=#0d0b0f
hi StatusLineNC       guibg=NONE         guifg=#C7C1BE
hi StorageClass       guibg=NONE         guifg=#C7C1BE
...
hi Type               guibg=NONE         guifg=#A29D9F
hi Typedef            guibg=NONE         guifg=#9a9997
hi VertSplit          guibg=NONE         guifg=#ffffff
hi Visual             guibg=#C2BCBA      guifg=#ffffff
